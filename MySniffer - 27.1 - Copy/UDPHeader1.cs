...
namespace Mysniffer
{
    public class UDPHeader
    {
        ...
        private byte[] byUDPData = new byte[4096];//Data carried by the TCP packet
        ...
        public UDPHeader(byte[] byBuffer, int nReceived)
        {
            ...
            {
                MessageBox.Show(ex.Message, "MJsniff UDP" + (nReceived), MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
