...
namespace MySniffer
{
    public class IPHeader
    {
        ...
        {
            MessageBox.Show(ex.Message, "Mysniffer", MessageBoxButtons.OK, 
        ...
        /// <summary>
        /// return Total length of the datagram - Header length
        /// </summary>
        ...
        /// <summary>
        /// return the flags (which indicate whether the data is fragmented or not)
        /// </summary>
        public string Flags
        {
            get
        ...
        /// <summary>
        /// return The last thirteen bits of the flags and fragmentation field 
        ...
        /// <summary>
        /// return The protocol field represents the protocol in the data portion
        /// of the datagram
        /// </summary>
